...
public class Subject_4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText eTxt1,eTxt2,eTxt3,eTxt4,eTxt5,eTxt6,eTxt7,eTxt8;
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (areAllEditTextsFilled()) {
                        double result = (e2 + e4 + e6 + e8) / (e1 + e3 + e5 + e7);
                        txtResult.setText("Your GPA :  " + result);
                    } else {

                        Toast.makeText(Subject_4.this, "Please fill in all the fields.", Toast.LENGTH_SHORT).show();
                    }
                } catch (NumberFormatException e) {

                    Toast.makeText(Subject_4.this, "Please Give Correct Inputs.", Toast.LENGTH_SHORT).show();
