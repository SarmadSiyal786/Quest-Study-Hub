...
public class Subject_6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EditText eTxt1,eTxt2,eTxt3,eTxt4,eTxt5,eTxt6,eTxt7,eTxt8,eTxt9,eTxt10,eTxt11,eTxt12;
            ...
            public void onClick(View view) {
                try {
                    ...
                    if (areAllEditTextsFilled()) {
                        double result = (e2 + e4 + e6 + e8 + e10 + e12) / (e1 + e3 + e5 + e7 + e9 + e11);
                        txtResult.setText("Your GPA :  " + result);
                    } else {

                        Toast.makeText(Subject_6.this, "Please fill all the fields.", Toast.LENGTH_SHORT).show();
                    }
                } catch (NumberFormatException e) {

                    Toast.makeText(Subject_6.this, "Please Give Correct Inputs.", Toast.LENGTH_SHORT).show();
